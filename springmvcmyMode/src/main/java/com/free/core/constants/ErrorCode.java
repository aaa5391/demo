package com.free.core.constants;
...
//    public static String USER_IS_NOT_EXIST = "200";//用户不存在
    public static String MATCH_PERSON_IS_EXIST = "200";//手机号已注册
    ...
    public static String EXISTS_NULL_PROMOTION_PERSON = "307";	//存在没有评判是否晋级的选手
    ...
    static {
        ...
        MSG.put(EXISTS_NULL_PROMOTION_PERSON, "还有一些选手没有评分晋级,请先进行相关操作");
        /*
         * 后端分割线
         */
