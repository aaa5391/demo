...
(function ( $, window, undefined ) {
    ...
    function getRequest() {
    	...
    	var sortobj=this.sortDictionary;
    	var json= JSON.stringify(sortobj);//修改传成json
        var request = {
    ...
    function renderPagination() {
        if ( this.options.navigation !== 0 ) {
            ...
            if ( this.rowCount !== -1 && paginationItems.length > 0 ) {
                ...
                renderPaginationItem.call( this, pagination, "first", "<i class='fa fa-angle-double-left'></i>", "first" )
                    ._bgEnableAria( current > 1 );*/
                renderPaginationItem.call( this, pagination, "first", "首页", "first" )
                    ._bgEnableAria( current > 1 );

                /*renderPaginationItem.call(this, pagination, "prev", "&lt;", "prev")
                 ._bgEnableAria(current > 1);*/
                renderPaginationItem.call( this, pagination, "prev", "<i class='fa fa-angle-left'></i>", "prev" )
                    ._bgEnableAria( current > 1 );
                ...
                /*renderPaginationItem.call(this, pagination, "next", "&gt;", "next")
                 ...
                 ._bgEnableAria(totalPages > current);*/
                renderPaginationItem.call( this, pagination, "next", "<i class='fa fa-angle-right'></i>", "next" )
                    ._bgEnableAria( totalPages > current );
                /*renderPaginationItem.call( this, pagination, "last", "<i class='fa fa-angle-double-right'></i>", "last" )
                    ._bgEnableAria( totalPages > current );*/
                renderPaginationItem.call( this, pagination, "last", "末页", "last" )
                    ._bgEnableAria( totalPages > current );
    ...
    function renderRowCountSelection( actions ) {
        ...
        if ( $.isArray( rowCountList ) ) {
            ...
            actions.append( dropDown );
            //FIX 添加tooltip的title
            dropDown.find(".dropdown-toggle" ).attr( "title", "设置每页显示的记录数" );
        }
    }
    ...
    Grid.defaults = {
        ...
        templates: {
            ...
            paginationItem: "<li class=\"{{ctx.css}}\"><a href='javascript:void(0)' data-page=\"{{ctx.page}}\" class=\"{{css.paginationButton}}\">{{ctx.text}}</a></li>",
